        ...
        <nav className="hidden items-end  text-xs font-medium sm:flex ">
          ...
          {!isAuth ? (
            <HashLink
              smooth
              to="/auth"
              className="px-3 py-1 text-black hover:bg-[#000080] hover:text-white font-medium outline-none focus:outline-1 focus:outline-dotted focus:outline-black"
            >
              Sign Up / Login
            </HashLink>
          ) : (
            <button
              ...
              className="px-3 py-1 text-black text-left hover:bg-[#000080] hover:text-white font-medium cursor-pointer outline-none focus:outline-1 focus:outline-dotted focus:outline-black"
            >
              Logout
            </button>
          )}
